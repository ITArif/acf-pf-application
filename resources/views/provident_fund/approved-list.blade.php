...
{{--                        <th style="width: 10px;" class="bg-success">Deposit Date</th>--}}
                        ...
                        <th style="width: 5px;" class="bg-success">Old Own/Org PF Deposit</th>
{{--                        <th style="width: 5px;" class="bg-success">Old Org PF Deposit</th>--}}
                        <th style="width: 5px;" class="bg-success">Old Total PF Deposit</th>
                        <th style="width: 5px;" class="bg-success">Change Own/Org PF Deposit</th>
...
{{--                            <td>{{$provident_fund->deposit_date}}</td>--}}
                            ...
                            <td>
                                <p><small style="color:blue;">Own PF Deposit: {{$provident_fund->old_own_pf}}</small></p>
                                <p><small style="color:blue;">Org PF Deposit: {{$provident_fund->old_organization_pf}}</small></p>
                            </td>
                            <td>{{ $provident_fund->old_total_pf}}</td>
{{--                            <td>{{$provident_fund->old_organization_pf}}</td>--}}
                            <td>
                                <p><small style="color:blue;">Change Own PF Deposit: {{ $provident_fund->own_pf }}</small></p>
                                <p><small style="color:blue;">Change Org PF Deposit: {{ $provident_fund->organisation_pf }}</small></p>
                            </td>
